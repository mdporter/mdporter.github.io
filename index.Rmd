    ...
    div(class="row", 
        ...
        div(class="col-sm-8", style="text-align:center",
            ...
            HTML(' 
              ...
              <h4> <i class="fa fa-home"></i> 432 Data Science Bldg</h4>
              <h4> <i class="fa fa-at"></i> mdporter@virginia.edu</h4>
              </div>
             '),
            br(),
            h3(a(href="https://engineering.virginia.edu/faculty/michael-d-porter", 
...
about = p("I'm an Associate Professor in the",
           ...
           "and the",                
               a(href="https://engineering.virginia.edu/sie", "Department of Systems and Information Engineering"),
...
research = div(
              ...
              "Criminology, Transportation, Transplant Medicine, Terrorism, Defense, Security, Forensics, Business"
)
