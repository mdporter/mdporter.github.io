...
div(class="row",
  div(class="col-sm-12", 
    ...
    bib %>% 
      ...
      pull(citation)),
    p("Recent Funding:"), 
    html_list("Center for Advanced Public Safety: <em> Predictive Crash Analytics </em>; $119,996.")    
))
```
...
Recent projects involve detecting anomalies in large dynamic networks and spatial event data."),
    ...
    bib %>% 
      ...
      pull(citation)),
    p("Recent Funding:"), 
    html_list("Centers for Disease Control and Prevention:  <em> Anomaly Detection in Space and Time </em>; $50,000.")
))
```
