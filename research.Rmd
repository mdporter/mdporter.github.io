...
div(class="row",
  div(class="col-sm-12", 
    ...
    p("Recent Funding:"), 
    html_list(c(
      "Agency for Healthcare Research and Quality (AHRQ): <em> Improving Pediatric Donor Heart Utilization with Predictive Analytics </em>; $1,025,000.",
      "National Highway Traffic Safety Administration (NHTSA): <em> Statistical Analysis for Motor Vehicle Crash Insights", 
      "Ivy Foundation COVID-19 Translational Research Fund: <em> Epidemiologic Modeling, Public Health Surveillance and Sewershed Monitoring to Predict Surges in the COVID-19 Pandemic </em>; $100,000.", 
...
div(class="row",
  div(class="col-sm-12", 
    ...
    p("Pattern and event detection is concerned with", 
      ...
      "This often involves problems where the quick detection of anomalies or unusual observations from a data stream is crucial (e.g., disease and crime outbreak detection, activation of terrorist sleeper cell). In addition to being able to detect the changes quickly, we should also be able to identify the cause of the event - like the spatial location where the outbreak started or the network neighborhood responsible for fraudulent financial activities. 
I have developed several techniques to detect change points and anomalies in high dimensional time-series based on scan statistics, a technique to quickly search over many time or space windows while properly accounting for multiple testing. 
