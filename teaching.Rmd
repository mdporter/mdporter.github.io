...
teaching = tibble::tribble(
  ...
  # 2021 Fall
  "DS 6030", "Statistical Learning", 2021, "Fall", "https://mdporter.github.io/DS6030",
  # 2021 Spring
  "DS 6030", "Statistical Learning (online)", 2021, "Spring", NA,
  "SYS 4582/6018", "Data Mining", 2021, "Spring", "https://mdporter.github.io/SYS6018/",
  "SYS 4054", "Systems Design II", 2021, "Spring", NA,
  # 2020 Fall
  "SYS 6018", "Data Mining", 2020, "Fall", "https://mdporter.github.io/SYS6018/",
  ...
  "SYS 6018", "Data Mining", 2019, "Fall", "https://mdporter.github.io/SYS6018/",
  "SYS 4055", "Systems Engineering Design Colloquium II", 2019, "Fall", NA,
  "SYS 4053", "Systems Design I", 2019, "Fall", NA,
  # 2019 Spring
  "SYS 4582/6018", "Data Mining", 2019, "Spring", "https://mdporter.github.io/SYS6018/",
  ...
  "ST 260",   "Statistical Data Analysis", 2014, "Fall", NA 
             ...
             course = ifelse(is.na(URL), paste("<p>", course, "</p>"), 
                             paste("<p>", 
                                   "<a class=teaching href=", URL, ">", paste0(id, ":"), "</a>",
                                   title,
                                   "</p>")))
